...
net = Net()
net.load_state_dict(torch.load(project_path+'model.pth',map_location=torch.device(device.type)))
Encoder=net.features #use pre trained net.features layers as the encoder of segmentation model
